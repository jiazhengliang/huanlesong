...
//- (void)setVideoMaxDuration:(NSInteger)videoMaxDuration {
//    _videoMaxDuration = videoMaxDuration;
//    [TZImageManager manager].videoMaxDuration = videoMaxDuration;
//}
...
- (void)viewDidLoad {
    ...
    //[TZImageManager manager].videoMaxDuration = self.videoMaxDuration;
