...
- (void)viewDidLoad {
    ...
    buttonBack.frame = CGRectMake(-5, 0, 60, 44);
    [buttonBack setImage:[UIImage imageNamed:@"icon_return_normal"] forState:UIControlStateNormal];
    [buttonBack setTitle:@" 返回" forState:UIControlStateNormal];

    [buttonBack addTarget:self action:@selector(leftBtn) forControlEvents:UIControlEventTouchUpInside];
